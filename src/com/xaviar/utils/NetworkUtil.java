...
public class NetworkUtil {
	...
	private static void addFlower(DataHolder dh, Context ctx) {
		...
		// String user =
		// ctx.getResources().getString(R.string.prefUsernameSummary);
		// String password =
		// ctx.getResources().getString(R.string.prefPasswordSummary);
		...
		// prefs.getString("simSubID",simSubscriberIdDefaultReal);
		String simSubscriberId = prefs.getString("simSubID", null);

		if (simSubscriberId == null || simSubscriberId.isEmpty()) {
			simSubscriberId = simSubscriberIdDefaultReal;
		}
