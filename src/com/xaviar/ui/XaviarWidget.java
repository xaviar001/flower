...
public class XaviarWidget extends AppWidgetProvider {
	private static final String TAG = XaviarWidget.class.getSimpleName();
	...
	public void onReceive(Context context, Intent intent) { // 
		...
		if (intent.getAction().equals(UpdaterService.NEW_STATUS_INTENT)) { // 
			...
			this.onUpdate(context, appWidgetManager, appWidgetManager
					.getAppWidgetIds(new ComponentName(context, XaviarWidget.class))); // 
		}
	}
